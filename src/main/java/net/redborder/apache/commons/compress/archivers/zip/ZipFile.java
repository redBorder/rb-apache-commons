...
public class ZipFile implements Closeable {
    ...
    private final byte[] DWORD_BUF = new byte[ZipConstants.DWORD];
    private final byte[] WORD_BUF = new byte[ZipConstants.WORD];
    private final byte[] CFH_BUF = new byte[CFH_LEN];
    private final byte[] SHORT_BUF = new byte[ZipConstants.SHORT];
    ...
    private void
        ...
        off += ZipConstants.SHORT; // skip version info
    ...
    private void setSizesAndOffsetFromZip64Extra(ZipArchiveEntry ze,
        ...
        if (z64 != null) {
            boolean hasUncompressedSize = ze.getSize() == ZipConstants.ZIP64_MAGIC;
            boolean hasCompressedSize = ze.getCompressedSize() == ZipConstants.ZIP64_MAGIC;
