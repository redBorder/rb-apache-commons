 ...
 * under the License.
 */
package net.redborder.apache.commons.compress.compressors.xz;

import java.io.IOException;
import java.io.InputStream;

import net.redborder.apache.commons.compress.compressors.CompressorInputStream;
import net.redborder.tukaani.xz.XZ;
import net.redborder.tukaani.xz.SingleXZInputStream;
import net.redborder.tukaani.xz.XZInputStream;
